...
class _MechanicAssignedPageState extends State<MechanicAssignedPage> {
  ...
  bool _hasHandledFinalStatus = false;
  ...
  void _startTracking() {
    _bookingSubscription = FirebaseFirestore.instance
        ...
        .listen((bookingSnapshot) {
          ...
          // ✅ Navigate to HomePage instead of pop
          if (!_hasHandledFinalStatus && mounted) {
            if (status.toLowerCase() == 'completed') {
              _hasHandledFinalStatus = true;
        ...
        await showDialog(
          ...
          builder:
              (context) => AlertDialog(
                ...
                content: const Text(
                  "Are you sure you want to cancel this booking? The mechanic will be notified immediately.",
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          mechanicLocation == null || userLocation == null
              ? const Center(
                child: Column(
